    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <aside class="hidden lg:flex lg:flex-col lg:w-72 bg-gradient-to-b from-gray-900 via-gray-900 to-gray-800 text-white shadow-2xl">
            ...
            <nav class="flex-1 overflow-y-auto py-8 px-4 space-y-2">
                ...
                <div class="group flex items-center px-4 py-3.5 text-gray-500 cursor-not-allowed opacity-60 rounded-xl">
                    <div class="w-10 h-10 rounded-lg flex items-center justify-center bg-gray-800/30">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"/>
                        </svg>
                    </div>
                    <span class="ml-3 font-medium">Kelola Member</span>
                    <span class="ml-auto text-xs bg-gray-800 px-2.5 py-1 rounded-full">Soon</span>
                </div>
            </nav>
